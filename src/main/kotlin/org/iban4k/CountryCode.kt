...
enum class CountryCode(
  ...
  /**
   * Country alpha3 code
   * [ISO 3166-3 alpha-3](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3) code.
   */
  val alpha3: String,
) {
  AD("Andorra", "AND"),
  ...
  val alpha2: String get() = name

  /**
   * Get the [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) code.
   *
   * @return The [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) code.
   */
  companion object {
    val entries: Set<CountryCode> = values().toSet()
    /**
     * Country alpha3 code map, maps alpha3 codes to country codes
     * [ISO 3166-3 alpha-3](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3) code.
     */
    private val alpha2Map: Map<String, CountryCode> = entries.associateBy { it.alpha2.uppercase() }
    private val alpha3Map: Map<String, CountryCode> = entries.associateBy { it.alpha3.uppercase() }
    private val alphaCodeMap: Map<String, CountryCode> = alpha2Map + alpha3Map
     ...
     *
     * @param code An ISO 3166-1 [alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) or
     * [alpha-3](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3) code.
     * @return A CountryCode instance, or null if not found.
     */
    fun getByCode(code: String?): CountryCode? {
      return when (code) {
        null -> null
        else -> alphaCodeMap[code.uppercase()]
      }
    }
  }
}
